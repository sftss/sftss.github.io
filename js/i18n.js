...
//             seeMeCvEn: "Voir mon CV internaltional",
...
// );
i18next
  .use(i18nextHttpBackend) //backend HTTP -> charger JSON
  .init(
    {
      lng: "en", // default
      // lng: detectUserLanguage(), // auto detect pour après
      backend: {
        loadPath: "/locales/{{lng}}/{{ns}}.json", //chemin vers JSON
      },
      ns: ["common", "projects"], //nom namespaces
      defaultNS: "common", //namespace défaut
      interpolation: {
        escapeValue: false,
      },
    },
