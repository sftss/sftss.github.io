          ...
          experience: {
            ...
            items: {
              dataAnalyst: {
                ...
                place: "Le Robot qui dit Non (remote)",
                b1: "UI redesign of an educational platform (Vue 3, Tailwind, TypeScript).",
                b2: "Built a full interactive MCQ module with animations and instant feedback.",
                b3: "Improved Lighthouse scores across accessibility, SEO, and best practices.",
                b4: "Documented product workflows and paired with QA to stabilize releases.",
                b5: "Set up end-to-end tests to secure the main learning flows.",
              },
              maintenance: {
                ...
                place: "Scodoc (remote)",
                b1: "Developed school-management modules (Python, Flask, PostgreSQL).",
                b2: "Created responsive Vue.js interfaces for input and reporting.",
                b3: "Optimized queries and handled critical data migrations.",
                b4: "Hardened endpoints with validation and monitored performance.",
              },
              operator: {
                type: "Front-End · Projects",
                dates: "2023 - 2024",
                title: "Front-End Developer",
                place: "Freelance / Student",
                b1: "Built fast showcase sites (HTML, CSS, vanilla JS).",
                b2: "Integrated GSAP micro-interactions and reusable UI components.",
              },
            },
            education: {
              heading: "Education",
              items: {
                ...
                bac: {
                  ...
                  place: "NSI / Mathematics specialization",
                },
              },
            },
          },
      ...
      fr: {
        translation: {
          ...
          experience: {
            ...
            items: {
              dataAnalyst: {
                type: "Front-End · Stage",
                dates: "Mai 2024 - Sep 2024",
                title: "Développeur Front-End",
                place: "Le Robot qui dit Non (remote)",
                b1: "Refonte UI d’une plateforme éducative (Vue 3, Tailwind, TypeScript).",
                b2: "Développement d’un module complet de QCM interactifs avec animations et feedback immédiat.",
                b3: "Amélioration des scores Lighthouse (accessibilité, SEO, bonnes pratiques).",
                b4: "Documentation des workflows produit et stabilisation avec l’équipe QA.",
                b5: "Mise en place de tests end-to-end pour sécuriser les parcours d’apprentissage.",
              },
              maintenance: {
                type: "Full-Stack · Stage",
                dates: "Jan 2024 - Avr 2024",
                title: "Développeur Full-Stack",
                place: "Scodoc (remote)",
                b1: "Développement de modules de gestion scolaire (Python, Flask, PostgreSQL).",
                b2: "Création d’interfaces réactives en Vue.js pour la saisie et le reporting.",
                b3: "Optimisation des requêtes et migrations de données critiques.",
                b4: "Renforcement des API avec validation et suivi des performances.",
              },
              operator: {
                type: "Front-End · Projets",
                dates: "2023 - 2024",
                title: "Développeur Front-End",
                place: "Freelance / Étudiant",
                b1: "Réalisation de sites vitrines performants (HTML, CSS, JS natif).",
                b2: "Intégration de micro-interactions GSAP et de composants réutilisables.",
              },
            },
            education: {
              heading: "Formation",
